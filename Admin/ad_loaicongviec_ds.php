...
?>
        <div class="container w-80 rounded-4 p-2 mb-4">
            <h1 class="text-center ">DANH SÁCH LOẠI CÔNG VIỆC</h1>
            <h1 class="text-center ">Tổng số loại: <?php echo $soluong_lcv;?></h1>
        </div>
        ...
        <div class="m-auto w-75 d-flex justify-content-center">
            ...
            <table id="dataTable" class="table text-center align-middle">
                ...
                <tbody>
                    ...
                    <?php
while ($cv = mysqli_fetch_assoc($ds_lcv)):
    ;
    ?>
                    <tr>
                        <th scope="row">
    ...
    $i += 1; ?>
                        ...
                        <td>
                            ...
                            <a class="btn"><a href="ad_loaicongviec_sua.php?chinhsua_ma=<?php echo $cv['LCV_MA']?>"><i class="fa-solid fa-pen-to-square"></i></a></a>
                            <a class="btn"><a href="ad_loaicongviec_xoa.php?xoa_ma=<?php echo $cv['LCV_MA']?>"><i class="fa-sharp fa-solid fa-trash"></i></a></a>
