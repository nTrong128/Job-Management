                        ...
                        <div class="p-3 pb-2">
                            ...
                            <form id="form" name="form" method="POST" class="form form_admin">
                                ...
                                <div class="my-2 text-center">
                                    <div class="btn_form"><a class="log_as_admin text-dark" href="../index.php">Đăng nhập với tư cách người dùng ?</a></div>

                                </div>
                                <div class="my-2 text-center">
                                    <button class="btn btn-primary profile-button w-50" name="dangnhapAdmin" type="dangnhapAdmin">Đăng nhập</button>
                                </div>
                            </form>
                        </div>
                        </form>
