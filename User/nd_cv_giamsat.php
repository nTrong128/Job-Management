...
<head>
    ...
    <title>Danh sách công việc đang giám sát</title>
</head>
...
while ($cv = mysqli_fetch_assoc($ds_cv)):
    ...
    $i += 1; ?>
                        ...
                        <td class="w-25">
                            ...
                            <a href="nd_giamsat_nhacnho.php?nd_ma=<?php echo $cv['CV_NTH'];?>&chitiet_ma=<?php echo $cv['CV_MA'];?>" class="btn btn-primary m-1">Nhắc nhở</a>
