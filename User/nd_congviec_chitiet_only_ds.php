...
?>
                        ...
                        <div class="row mt-2">
                            <div class="mt-2 col"><label for="tiendo" class="labels">Tiến độ</label>
                                <input readonly type="number" min="<?php echo $cv['CV_TIENDO'];?>" max="100" id="tiendo" name="tiendo" id="tiendo" class="form-control" placeholder="Tiến độ"
                                    value="<?php echo $cv['CV_TIENDO'];?>">
                            </div>
                            <div class="mt-2 col"><label for="trangthai" class="labels">Trạng thái</label>
                                <input readonly type="text" id="trangthai" name="trangthai" id="trangthai" class="form-control" placeholder="Trạng thái" value="<?php echo $cv['CV_TRANGTHAICV'];?>">
                            </div>
                        </div>
                        <div class="row mt-2">
