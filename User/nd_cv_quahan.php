...
<head>
    ...
    <title>Danh sách công việc quá hạn</title>
</head>
...
while ($cv = mysqli_fetch_assoc($ds_cv)):
    ...
    $i += 1; ?>
                        ...
                        <td class="w-25">
                            <a href="nd_congviec_chitiet_only_ds.php?turn_back=nd_cv_quahan&chitiet_ma=<?php echo $cv['CV_MA']?>" class="btn btn-secondary m-1">Xem chi tiết</a>
